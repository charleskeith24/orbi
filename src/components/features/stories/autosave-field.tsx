...
/**
 * Draft for a stored text field: saves on blur (Enter for single-line, ⌘/Ctrl+Enter for multi-line)
 * and when it unmounts mid-edit (sheet closed, tab switched). Outside changes flow in while idle.
 */
