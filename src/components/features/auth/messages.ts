...
export const authMessages = defineMessages({
  en: {
    ...
    link_sent: "If {email} has an Orbi account, a sign-in link is on its way. Check spam too.",
    ...
    // {terms} and {privacy} are links to /terms and /privacy.
    consent_label: "I agree to the {terms} and the {privacy}",
    consent_terms: "Terms",
    consent_privacy: "Privacy notice",
  ...
  tl: {
    ...
    link_sent: "Kung may Orbi account ang {email}, papunta na ang sign-in link. Tingnan din ang spam.",
    ...
    consent_label: "Agree ako sa {terms} at sa {privacy}",
    consent_terms: "Terms",
    consent_privacy: "Privacy notice",
...
export const authErrorMessages = defineMessages({
  en: {
    ...
    signup_disabled: "New accounts come from the waitlist. Request access to join.",
    email_provider_disabled: "Email sign-in is disabled. Enable the Email provider in Supabase → Authentication.",
    otp_disabled: "There's no account for that email yet. Check the spelling, or request access.",
  ...
  tl: {
    ...
    signup_disabled: "Sa waitlist nanggagaling ang bagong accounts. Mag-request ng access para makasali.",
    email_provider_disabled: "Naka-disable ang email sign-in. I-enable ang Email provider sa Supabase → Authentication.",
    otp_disabled: "Wala pang account ang email na 'yan. I-check ang spelling, o mag-request ng access.",
