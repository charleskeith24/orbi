...
/** AI affordances. Engine names (Claude, OpenAI, Gemini) and "Offline templates" stay as product names. */
export const aiMessages = defineMessages({
  en: {
    generating: "Generating…",
    explain_anthropic: "Generated by Claude{model}, with your Brand HQ, audience, pillars and winners as context.",
    explain_openai: "Generated by OpenAI{model}, with your Brand HQ, audience, pillars and winners as context.",
    explain_gemini: "Generated by Gemini{model}, with your Brand HQ, audience, pillars and winners as context.",
    explain_offline:
      "Offline templates: assembled from your Brand HQ, audience, pillars and winners — no AI model is involved. Add your own AI key in Settings → AI to use Claude, OpenAI or Gemini.",
    explain_offline_local:
  ...
  tl: {
    generating: "Ginagawa…",
    explain_anthropic: "Ginawa ng Claude{model}, na may Brand HQ, audience, pillars at winners mo bilang context.",
    explain_openai: "Ginawa ng OpenAI{model}, na may Brand HQ, audience, pillars at winners mo bilang context.",
    explain_gemini: "Ginawa ng Gemini{model}, na may Brand HQ, audience, pillars at winners mo bilang context.",
    explain_offline:
      "Offline templates: pinagsama-sama mula sa Brand HQ, audience, pillars at winners mo — walang AI model. Ilagay ang sarili mong AI key sa Settings → AI para magamit ang Claude, OpenAI o Gemini.",
    explain_offline_local:
